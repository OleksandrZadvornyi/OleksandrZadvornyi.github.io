      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <a 
            ...
            className="group bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-blue-500 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 flex flex-col items-center"
          >
            <div className="p-4 bg-blue-500/10 rounded-full text-blue-400 group-hover:bg-blue-500 group-hover:text-white transition-colors mb-4">
              <LuMail size={32} />
            </div>
            <h3 className="text-xl font-bold text-white mb-2">Email Me</h3>
            <p className="text-gray-400 text-sm mb-4">zadvornyi.alex16@gmail.com</p>
        ...
        {/* Quick Info Row */}
        <div className="flex flex-wrap justify-center gap-8 text-gray-400 border-t border-slate-800 pt-8">
